...
func genTypeScript(m *schema.Manifest, outDir string) error {
	...
	for _, name := range m.Order {
		...
		b.WriteString("  public expression(sql: string, values: readonly unknown[] = []): this { this.core.expression(sql,values); return this; }\n")
		...
		b.WriteString("  public async gets(): Promise<Collection<" + ge.Type + "Row>> { return await this.terminal('all') as Collection<" + ge.Type + "Row>; }\n")
