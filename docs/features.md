...
- `constraints_and_relations`: Preserve CHECK, index, foreign-key, and soft-delete metadata in the planner and migration system. Many-to-many and relation predicates remain incomplete.
