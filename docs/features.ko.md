...
- `constraints_and_relations`: CHECK, index, foreign-key, soft-delete, relation existence, relation count metadata를 planner와 migration system에서 보존한다. many-to-many는 미완료 상태다.
