...
- `constraints_and_relations`: CHECK, index, foreign-key, soft-delete, relation existence, relation count, many-to-many through metadata를 planner와 migration system에서 보존한다. 생성 client와 물리 through 실행은 미완료 상태다.
