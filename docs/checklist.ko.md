...
- [ ] T2.15 결정적인 150테이블 Rust fixture를 생성·컴파일하고 결과를 기록한다. 필요하면 `--tables` 분할을 문서화한다.
...
- [~] T7.8 TypeScript 구조·AST 검사를 구현했다. TypeScript 실행기와 공통 벡터 실행이 남아 있다.
...
- [ ] T7.12 결정적인 150테이블 Rust fixture와 컴파일 검사를 추가한다.
...
- [ ] G2 150테이블 Rust compile 검사를 완료한다.
