...
|---|---|---|---|
| `json`, `jsons` | ordered-json text from the common value model | ordered-json parse | `github.com/polyspec/ordered-json/go` at immutable revision `v0.0.0-20260915123419-26c2aebc9789` |
