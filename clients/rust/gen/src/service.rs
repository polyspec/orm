...
impl<'a> ServiceWhere<'a> {
    ...
    pub fn count_modules_eq(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.w.nav_with_count("modules", "eq", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_gte(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.w.nav_with_count("modules", "gte", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_gt(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.w.nav_with_count("modules", "gt", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_lte(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.w.nav_with_count("modules", "lte", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_lt(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.w.nav_with_count("modules", "lt", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_not_eq(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.w.nav_with_count("modules", "not_eq", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
...
impl Service {
    ...
    pub fn count_modules_eq(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.q.w().nav_with_count("modules", "eq", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_gte(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.q.w().nav_with_count("modules", "gte", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_gt(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.q.w().nav_with_count("modules", "gt", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_lte(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.q.w().nav_with_count("modules", "lte", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_lt(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.q.w().nav_with_count("modules", "lt", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    pub fn count_modules_not_eq(mut self, value: i64, f: impl FnOnce(super::service_module::ServiceModuleWhere<'_>) -> super::service_module::ServiceModuleWhere<'_>) -> Self { self.q.w().nav_with_count("modules", "not_eq", value, |w| { f(super::service_module::ServiceModuleWhere { w }); }); self }
    ...
    pub fn relations(mut self, child: impl AsRef<Q>) -> Self {
        let c = child.as_ref();
        match (c.entity(), c.link_left.as_str(), c.link_right.as_str()) {
            ("battle", "seq", "service_seq") => { self.q.relation("battles", c); self },
            ...
            ("service_module", "seq", "service_seq") => { self.q.relation("modules", c); self },
            ("service_module", "", "") => { self.q.relation("modules", c); self },
    ...
    pub fn join_seq_with_service_seq_to_battle(mut self, child: impl AsRef<super::battle::Battle>) -> Self { self.q.join("battles", "inner", &child.as_ref().q); self }
    pub fn left_join_seq_with_service_seq_to_battle(mut self, child: impl AsRef<super::battle::Battle>) -> Self { self.q.join("battles", "left", &child.as_ref().q); self }
    pub fn relations_seq_with_service_seq_to_battle(mut self, child: impl AsRef<super::battle::Battle>) -> Self { self.q.relation("battles", &child.as_ref().q); self }
    ...
    pub fn join_seq_with_service_seq_to_service_module(mut self, child: impl AsRef<super::service_module::ServiceModule>) -> Self { self.q.join("modules", "inner", &child.as_ref().q); self }
    pub fn left_join_seq_with_service_seq_to_service_module(mut self, child: impl AsRef<super::service_module::ServiceModule>) -> Self { self.q.join("modules", "left", &child.as_ref().q); self }
    pub fn relations_seq_with_service_seq_to_service_module(mut self, child: impl AsRef<super::service_module::ServiceModule>) -> Self { self.q.relation("modules", &child.as_ref().q); self }
