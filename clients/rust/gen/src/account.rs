...
impl<'a> AccountWhere<'a> {
    ...
    pub fn and(mut self, f: impl FnOnce(AccountWhere<'_>) -> AccountWhere<'_>) -> Self { self.w.and_with(|w| { f(AccountWhere { w }); }); self }
...
impl Account {
    ...
    pub fn and(mut self, f: impl FnOnce(AccountWhere<'_>) -> AccountWhere<'_>) -> Self { self.q.w().and_with(|w| { f(AccountWhere { w }); }); self }
