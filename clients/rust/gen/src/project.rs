...
pub struct ProjectRow {
    ...
    pub seq: i64,
    pub name: String,
    accounts_: Collection<super::account::AccountRow>,
...
impl ProjectRow {
            ...
            match ch.rel.as_str() {
                "accounts" => {
                    ...
                    for row in related {
                        ...
                        c.put(k, super::account::AccountRow::from_row(&mut row, rs.step_assemble(ch), rs)?);
                    }
                    r.accounts_ = c;
                }
                _ => {}
    ...
    pub fn to_map(&self) -> Result<serde_json::Value> {
        ...
        if a.has_child("accounts") {
            m.insert("accounts".into(), self.accounts_.to_map()?);
        }
    ...
    pub fn accounts(&self) -> &Collection<super::account::AccountRow> { &self.accounts_ }
    pub fn accounts_mut(&mut self) -> &mut Collection<super::account::AccountRow> { &mut self.accounts_ }
    ...
    pub fn delete_cascade_in<'a>(&'a self, tx: &'a db::Tx) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<()>> + Send + 'a>> {
        Box::pin(async move {
            ...
            for ch in a.children.iter().filter(|ch| ch.cascade) {
                match ch.rel.as_str() {
                    "accounts" => {
                        for (_, r) in self.accounts_.iter() { r.delete_cascade_in(tx).await?; }
                    }
                    _ => {}
                }
            }
...
impl orm::collection::RowExport for ProjectRow {
...
/// Where builder for project: predicates, or(), and(|w| …), relation navigation.
pub struct ProjectWhere<'a> { pub(crate) w: W<'a> }
...
impl<'a> ProjectWhere<'a> {
    ...
    pub fn not_has_accounts(mut self, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_mode("accounts", "not_exists", |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_eq(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_count("accounts", "eq", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_gte(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_count("accounts", "gte", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_gt(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_count("accounts", "gt", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_lte(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_count("accounts", "lte", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_lt(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_count("accounts", "lt", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_not_eq(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.w.nav_with_count("accounts", "not_eq", value, |w| { f(super::account::AccountWhere { w }); }); self }
...
/// Query over project: query() → using(&db) → chain → terminal().await.
pub struct Project {
    binding: Binding,
    pub q: Q,
    key_fn: Option<Box<dyn Fn(&ProjectRow) -> Key + Send + Sync>>,
}

/// Construct a query over project.
pub fn query() -> Project {
    Project { binding: Binding::default(), q: Q::new(super::schema_hash(), "project"), key_fn: None }
}
...
impl Project {
    ...
    pub fn key_by_fn(mut self, f: impl Fn(&ProjectRow) -> Key + Send + Sync + 'static) -> Self { self.key_fn = Some(Box::new(f)); self }
    ...
    pub fn not_has_accounts(mut self, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_mode("accounts", "not_exists", |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_eq(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_count("accounts", "eq", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_gte(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_count("accounts", "gte", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_gt(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_count("accounts", "gt", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_lte(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_count("accounts", "lte", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_lt(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_count("accounts", "lt", value, |w| { f(super::account::AccountWhere { w }); }); self }
    pub fn count_accounts_not_eq(mut self, value: i64, f: impl FnOnce(super::account::AccountWhere<'_>) -> super::account::AccountWhere<'_>) -> Self { self.q.w().nav_with_count("accounts", "not_eq", value, |w| { f(super::account::AccountWhere { w }); }); self }
    ...
    pub fn on(mut self, f: impl FnOnce(ProjectWhere<'_>) -> ProjectWhere<'_>) -> Self { { let w = self.q.on_w(); f(ProjectWhere { w }); } self }
    pub fn where_(mut self, f: impl FnOnce(ProjectWhere<'_>) -> ProjectWhere<'_>) -> Self { { let w = self.q.w(); f(ProjectWhere { w }); } self }
    pub fn relation(mut self, child: impl AsRef<Q>) -> Self {
        let c = child.as_ref();
        match (c.entity(), c.link_left.as_str(), c.link_right.as_str()) {
            _ => panic!("no one-to-one relation from project"),
        }
    }
    pub fn relations(mut self, child: impl AsRef<Q>) -> Self {
        let c = child.as_ref();
        match (c.entity(), c.link_left.as_str(), c.link_right.as_str()) {
            ("account", "seq", "seq") => { self.q.relation("accounts", c); self },
            ("account", "", "") => { self.q.relation("accounts", c); self },
            _ => panic!("no one-to-many relation from project"),
        }
    }
    ...
    fn join_target(mut self, child: impl AsRef<Q>, _kind: &str) -> Self {
        let c = child.as_ref();
        match (c.entity(), c.link_left.as_str(), c.link_right.as_str()) {
            ("account", "seq", "seq") => { self.q.join("accounts", _kind, c); self },
            ("account", "", "") => { self.q.join("accounts", _kind, c); self },
            _ => panic!("no relation from project"),
        }
    }

    pub fn join_seq_with_seq(mut self, child: impl AsRef<super::account::Account>) -> Self { self.q.join("accounts", "inner", &child.as_ref().q); self }
    pub fn left_join_seq_with_seq(mut self, child: impl AsRef<super::account::Account>) -> Self { self.q.join("accounts", "left", &child.as_ref().q); self }
    pub fn relations_seq_with_seq(mut self, child: impl AsRef<super::account::Account>) -> Self { self.q.relation("accounts", &child.as_ref().q); self }
    ...
    pub fn having(mut self, f: impl FnOnce(ProjectWhere<'_>) -> ProjectWhere<'_>) -> Self { { let w = self.q.having_w(); f(ProjectWhere { w }); } self }
    ...
    // ---- terminals ----
    pub async fn get(&mut self) -> Result<ProjectRow> { let row = self.get_or_none().await?; row.ok_or(orm::Error::NoRows) }

    pub async fn get_or_none(&mut self) -> Result<Option<ProjectRow>> { let binding = self.binding.clone(); let ex = binding.resolve()?;
        let mut rows = db::select(ex, &mut self.q.req, "one").await?;
        Ok(match rows.take_cells().into_iter().next() {
            Some(mut src) => Some(ProjectRow::from_row(&mut src, &rows.assemble, &rows)?),
            None => None,
        })
    }

    pub async fn gets(&mut self) -> Result<Collection<ProjectRow>> { let binding = self.binding.clone(); let ex = binding.resolve()?;
        let mut rows = db::select(ex, &mut self.q.req, "all").await?;
        collect(&mut rows, self.key_fn.as_deref())
    }

    pub async fn gets_after(&mut self, cursor: &str, per: u32) -> Result<orm::KeysetPage<ProjectRow>> {
    ...
    pub async fn gets_before(&mut self, cursor: &str, per: u32) -> Result<orm::KeysetPage<ProjectRow>> {
    ...
    pub async fn stream(&mut self, visit: impl FnMut(ProjectRow) -> bool) -> Result<db::StreamResult> {
        let mut visit = visit;
        let binding = self.binding.clone();
        let ex = binding.resolve()?;
        db::stream(ex, &mut self.q.req, |mut src, rows| {
            let row = ProjectRow::from_row(&mut src, &rows.assemble, rows)?;
            Ok(visit(row))
        }).await
    }
    ...
    pub async fn gets_by_seq(&mut self, v: i64) -> Result<Collection<ProjectRow>> {
        self.q.w().pred("seq", "eq", v);
        self.gets().await
    }

    /// Applies name = value and runs the collection terminal.
    pub async fn gets_by_name(&mut self, v: impl Into<String>) -> Result<Collection<ProjectRow>> {
    ...
    pub async fn gets_count(&mut self) -> Result<Collection<ProjectRow>> { let binding = self.binding.clone(); let ex = binding.resolve()?;
    ...
    pub async fn paginate(&mut self, page: u32, per: u32) -> Result<Page<ProjectRow>> { let binding = self.binding.clone(); let ex = binding.resolve()?;
    ...
    pub async fn insert(&mut self) -> Result<Option<ProjectRow>> { let binding = self.binding.clone(); let ex = binding.resolve()?;
        let (id, _) = db::write(ex, &mut self.q.req, "insert").await?;
        super::project::query().using(ex).seq_eq(id as i64).get_or_none().await
    }

    /// With set_seq: UPDATE the other set columns WHERE seq = that value and re-read the row; otherwise INSERT.
    pub async fn save(&mut self) -> Result<Option<ProjectRow>> { let binding = self.binding.clone(); let ex = binding.resolve()?;
        match self.q.take_sets(&["seq"])? {
            Some(keys) => {
                db::write(ex, &mut self.q.req, "update").await?;
                let mut q = super::project::query().using(ex);
    ...
    pub async fn batch_insert(&self, rows: Vec<Project>, options: orm::BatchOptions) -> Result<orm::BatchResult> { self.batch_write(rows, "insert", options).await }
    pub async fn batch_upsert(&self, rows: Vec<Project>, options: orm::BatchOptions) -> Result<orm::BatchResult> { self.batch_write(rows, "insert", options).await }
    pub async fn batch_update(&self, rows: Vec<Project>, options: orm::BatchOptions) -> Result<orm::BatchResult> { self.batch_write(rows, "update", options).await }
    pub async fn batch_delete(&self, rows: Vec<Project>, options: orm::BatchOptions) -> Result<orm::BatchResult> { self.batch_write(rows, "delete", options).await }
    async fn batch_write(&self, rows: Vec<Project>, kind: &str, options: orm::BatchOptions) -> Result<orm::BatchResult> {
        let binding = self.binding.clone(); let ex = binding.resolve()?;
    ...
    pub async fn get_by_seq(&mut self, v: i64) -> Result<Option<ProjectRow>> {
        self.q.w().pred("seq", "eq", v);
...
impl AsRef<Project> for Project { fn as_ref(&self) -> &Self { self } }
impl AsRef<Q> for Project { fn as_ref(&self) -> &Q { &self.q } }

impl Default for Project { fn default() -> Self { query() } }

fn collect(rows: &mut db::Rows, key_fn: Option<&(dyn Fn(&ProjectRow) -> Key + Send + Sync)>) -> Result<Collection<ProjectRow>> {
    use orm::Src as _;
    ...
    for mut src in cells {
        ...
        let r = ProjectRow::from_row(&mut src, &rows.assemble, rows)?;
