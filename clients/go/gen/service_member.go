...
func (w *ServiceMemberWhere) HasBattles(fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavMode("battles", "exists", func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) NotHasBattles(fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavMode("battles", "not_exists", func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) CountBattlesEq(v int64, fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavCount("battles", "eq", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) CountBattlesGte(v int64, fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavCount("battles", "gte", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) CountBattlesGt(v int64, fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavCount("battles", "gt", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) CountBattlesLte(v int64, fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavCount("battles", "lte", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) CountBattlesLt(v int64, fn func(*BattleWhere)) *ServiceMemberWhere {
	w.w.NavCount("battles", "lt", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return w
}
func (w *ServiceMemberWhere) CountBattlesNotEq(v int64, fn func(*BattleWhere)) *ServiceMemberWhere {
...
func (q *ServiceMemberQuery) HasBattles(fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavMode("battles", "exists", func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) NotHasBattles(fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavMode("battles", "not_exists", func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) CountBattlesEq(v int64, fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavCount("battles", "eq", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) CountBattlesGte(v int64, fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavCount("battles", "gte", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) CountBattlesGt(v int64, fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavCount("battles", "gt", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) CountBattlesLte(v int64, fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavCount("battles", "lte", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) CountBattlesLt(v int64, fn func(*BattleWhere)) *ServiceMemberQuery {
	q.q.W().NavCount("battles", "lt", v, func(x *orm.W) { fn(&BattleWhere{w: x}) })
	return q
}
func (q *ServiceMemberQuery) CountBattlesNotEq(v int64, fn func(*BattleWhere)) *ServiceMemberQuery {
...
func (q *ServiceMemberQuery) Relations(child any) *ServiceMemberQuery {
	if c, ok := child.(*BattleQuery); ok {
		if c.q.LinkLeft != "" && (c.q.LinkLeft != "seq" || c.q.LinkRight != "service_member_seq") {
			q.q.Req.Err = &ir.Error{Code: "RELATION_UNKNOWN", Msg: "link selection does not match relation"}
			return q
		}
...
func (q *ServiceMemberQuery) MatchServiceMemberSeqWithSeq() *ServiceMemberQuery {
	q.q.SetLink("service_member_seq", "seq")
	return q
}
func (q *ServiceMemberQuery) OnServiceMemberSeqWithSeq() *ServiceMemberQuery {
	q.q.SetLink("service_member_seq", "seq")
	return q
}
func (q *ServiceMemberQuery) MatchSeqWithUserSeq() *ServiceMemberQuery {
	q.q.SetLink("seq", "user_seq")
	return q
}
func (q *ServiceMemberQuery) OnSeqWithUserSeq() *ServiceMemberQuery {
	q.q.SetLink("seq", "user_seq")
	return q
}
func (q *ServiceMemberQuery) MatchSeqWithServiceSeq() *ServiceMemberQuery {
	q.q.SetLink("seq", "service_seq")
	return q
}
func (q *ServiceMemberQuery) OnSeqWithServiceSeq() *ServiceMemberQuery {
	q.q.SetLink("seq", "service_seq")
	return q
}
...
func (q *ServiceMemberQuery) Stream(visit func(*ServiceMemberRow) bool) (orm.StreamResult, error) {
	ctx, ex, err := q.binding.Resolve()
	if err != nil {
	...
	return orm.Stream(ctx, ex, q.q.Req, func(vals []any, rows *orm.Rows) bool {
		return visit(scanServiceMember(vals, rows.Assemble, rows))
	})
}
...
func (q *ServiceMemberQuery) BatchInsert(rows []*ServiceMemberQuery, options orm.BatchOptions) (orm.BatchResult, error) {
...
func (q *ServiceMemberQuery) BatchUpsert(rows []*ServiceMemberQuery, options orm.BatchOptions) (orm.BatchResult, error) {
	return q.batchWrite(rows, "insert", options)
}

// BatchUpdate updates typed query drafts in one transaction.
func (q *ServiceMemberQuery) BatchUpdate(rows []*ServiceMemberQuery, options orm.BatchOptions) (orm.BatchResult, error) {
	return q.batchWrite(rows, "update", options)
}

// BatchDelete deletes typed query drafts in one transaction.
func (q *ServiceMemberQuery) BatchDelete(rows []*ServiceMemberQuery, options orm.BatchOptions) (orm.BatchResult, error) {
	return q.batchWrite(rows, "delete", options)
}
func (q *ServiceMemberQuery) batchWrite(rows []*ServiceMemberQuery, kind string, options orm.BatchOptions) (orm.BatchResult, error) {
	ctx, ex, err := q.binding.Resolve()
	if err != nil {
