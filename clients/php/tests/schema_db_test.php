...
function liveCycle(string $driver, string $dsn): void
{
    ...
    $live = $state($base);
    check(SchemaMigrate::schemaMatches($base, $live, $driver), 'created schema does not match: ' . implode('; ', SchemaImport::differences($base, $live, $driver)));
    ...
    $live = $state($target);
    check(SchemaMigrate::schemaMatches($target, $live, $driver), 'added column does not verify: ' . implode('; ', SchemaImport::differences($target, $live, $driver)));
    ...
    $live = $state($base);
    check(SchemaMigrate::schemaMatches($base, $live, $driver), 'removed column does not verify: ' . implode('; ', SchemaImport::differences($base, $live, $driver)));
