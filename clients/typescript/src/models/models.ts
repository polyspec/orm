...
import { CORE, Model, registerSchema, type CodecValue, type Collection, type ColumnFunction, type EntityDef, type EntitySchema, type JsonValue, type Point, type SchemaSet, type ValueFunction } from '../index.js';

export const SCHEMA_HASH = '16198b563e2e3cae';
...
const schema: SchemaSet = { hash: SCHEMA_HASH, entities: new Map<string, EntitySchema>([
  ...
  ['task', { name: 'task', table: 'task', pk: ['seq'], auto: 'seq', fulltext: [], columns: {
    seq: { type: 'i64' },
    title: { type: 'string' },
    state: { type: 'enum' },
  } }],
...
export class Battle extends Model {
  ...
  public getJsonSetting(): JsonValue | null { return this[CORE].column('json_setting') as JsonValue | null; }
  public setJsonSetting(value: JsonValue | CodecValue | null): this { this[CORE].setValue('json_setting', value); return this; }
  ...
  public getJsonsTags(): JsonValue | null { return this[CORE].column('jsons_tags') as JsonValue | null; }
  public setJsonsTags(value: JsonValue | CodecValue | null): this { this[CORE].setValue('jsons_tags', value); return this; }
...
export interface Battle {
  ...
  andSuccessCountLtSeq(v0: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  ...
  joinServiceMemberSeqWithSeq(child: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  joinServiceSeqWithSeq(child: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  joinUserSeqWithSeq(child: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  leftJoinServiceModuleSeqWithSeq(child: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  leftJoinUserSeqWithSeq(child: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  ...
  readCountGtSeq(v0: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
  ...
  userSeqEqSeq(v0: Battle | User | Service | ServiceModule | ServiceMember | SoftRecord | Account | Project | Task): this;
...
export class Task extends Model {
  public static readonly entity: EntityDef = { schema: schema.entities.get('task')!, set: schema, create: core => new Task(core) };
  public getSeq(): number { return this[CORE].column('seq') as number; }
  public setSeq(value: number): this { this[CORE].setValue('seq', value); return this; }
  public setRawSeq(sql: string, ...binds: unknown[]): this { this[CORE].putSet({ column: 'seq', raw: { sql, binds } }); return this; }
  public addColumnSeq(): this { this[CORE].addColumn('seq'); return this; }
  ...
  public keyNameTitle(): this { this[CORE].keyName = 'title'; return this; }
  public orderByTitleAsc(...fn: ColumnFunction[]): this { this[CORE].orderBy('title', false, fn); return this; }
  ...
  public keyNameState(): this { this[CORE].keyName = 'state'; return this; }
  public orderByStateAsc(...fn: ColumnFunction[]): this { this[CORE].orderBy('state', false, fn); return this; }
