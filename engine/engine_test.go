...
func TestUpsertAndCascade(t *testing.T) {
	...
	for irs, code := range map[string]string{
		...
		`"kind":"insert","entity":"battle","n_params":8,"set":[{"column":"name","p":0},{"column":"user_seq","p":1},{"column":"service_seq","p":2},{"column":"service_module_seq","p":3},{"column":"service_member_seq","p":4},{"column":"start_dt","p":5},{"column":"end_dt","p":6}],"on_duplicate":[{"column":"aes_hex_email","p":7}]`: "IR_INVALID: AES update must assign every AES column; missing aes_hex_phone",
		`"kind":"insert","entity":"task","n_params":1,"set":[{"column":"title","p":0}]`:                                                                                                                                                                                                                                                 "IR_INVALID: required column task.state is not set",
		`"kind":"insert","entity":"battle","n_params":1,"set":[{"column":"name","p":0}]`:                                                                                                                                                                                                                                                "IR_INVALID: required column battle.user_seq is not set",
